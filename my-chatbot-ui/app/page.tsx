...
return (
  <LayoutWrapper>
    ...
    <div style={{ display: "flex", height: "100vh", width: "100vw", background: "#111111" }}>
      {/* ✅ 사이드바 영역 (고정 폭) */}
      ...
      >
        ...
        {/* ✅ 제목 */}
        <h1 className={styles.title} style={{color: "white", fontWeight: "bold"}}>📚 Personal RAG Chatbot</h1>

        {/* ✅ 업로드 / 검색 */}
        <div className={styles.row}>
          <div className={`${styles.card} ${styles.uploadCard}`}>
            <div className={styles.cardHeader}>
              <h3 style={{color: "white", fontWeight: "bold"}}>📄 문서 업로드</h3>
          ...
          <div className={`${styles.card} ${styles.searchCard}`}>
            <div className={styles.cardHeader}>
              <h3 style={{color: "white", fontWeight: "bold"}}>🔍 문서 검색</h3>
              <span className={styles.cardSubTitle}>
